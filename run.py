...
try:
    ...
    #print(stpDomain.getSwitchRootPort(stp_domain, 's2', human_readable=True))
    #print(stpDomain.getSwitchBridgeID(stp_domain, 's2', human_readable=True))
    #print(stpDomain.getSwitchPortPriorityAndID(stp_domain, 's2', 's3', human_readable=True))
    #print(stpDomain.getSwitchLinkToNeighborCost(stp_domain, 's2', 's3', human_readable=True))
